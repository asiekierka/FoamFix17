...
import pl.asie.foamfix.repack.com.unascribed.ears.EarsFeaturesLookup;
...
public class EarsFeatures {
	...
	private static Object getLookupImpl() throws Throwable {
		return Class.forName("pl.asie.foamfix.repack.com.unascribed.ears.common.EarsFeaturesStorage").getField("INSTANCE").get(null);
	}
